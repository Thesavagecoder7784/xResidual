...
GROUPS = [
    ...
    ("Goal under-reaction, clean-reconstruction subset (scripts/underreaction_clean.py)", [
        ...
        auto("urGapAll",       lambda D: num(dig(D, "R", "outcome_test.logloss_gap_market_minus_model"), 3), "0.126", "pooled log-loss gap, market minus model"),
        auto("urGapNoTop",     lambda D: num(dig(D, "R", "outcome_test.logloss_gap_without_largest_goal"), 3), "0.043", "the same gap without its largest single goal"),
        auto("urTopMatch",     lambda D: str(dig(D, "R", "outcome_test.largest_single_goal.match")).replace(" vs ", "--"), "Ghana--Panama", "the goal that carries most of the gap"),
