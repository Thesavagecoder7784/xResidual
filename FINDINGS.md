...
Live snapshot, updated 2026-07-17: the World Cup is **all but complete** — only the third-place playoff (Jul 18) and the **Spain–Argentina final (Jul 19)** remain, after which the pre-registered scorecard grades. Data has accumulated since June 5, 2026. Claims sharpen as the sample grows; small-sample reads are flagged, and the pre-tournament reads below now have full contact with results to test them against.
