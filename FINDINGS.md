...
> - **CAN claim:** BTTS (calibrated, esp. BTTS-YES); the cross-venue flagship (Polymarket leads ~71% of decisive events / ~80.6% info share, 56 of 65 and 59 of 61 matches respectively, lead un-harvestable — significance is the **match**, never the event); and the headline — **the market is better calibrated than the pre-committed model** (P1, in-band, +17% skill over 58 games).
