...
|---|---|---|
| Reaction lead (event study) | 84 matches, 377 decisive events | Polymarket first in 264 (71%), median +600 ms |
| Reaction lead, per match (cluster-robust) | 64 matches | 56 of 65 lean Polymarket (sign test p ≈ 3×10⁻⁹; design effect 1.13) |
| Gonzalo–Granger share | 61 cointegrated matches | Polymarket ~80% (median), leads 59 of 61 (p ≈ 3×10⁻¹⁵) |
